...
public class CompressPic {
    ...
    private static Logger logger = LoggerFactory.getLogger(CompressPic.class);


    public CompressPic() {
    }

    public CompressPic(boolean proportion) {
     ...
     * @return
     */
    public CompressPic setInputInfo(String inputDir, String inputFileName) {
     ...
     * @return
     */
    public CompressPic setOutputInfo(String outputDir, String outputFileName, int outputHeight, int outputWidth, boolean proportion) {
